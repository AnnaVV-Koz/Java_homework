...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        c[5] = new Customer(6, "Петрук", "Паша", "Иванович", "Фрунзе_76", 34523145, 98239877);
        //task1
        String[] arrCustom = {"Кравец", "Буланов", "Воронова", "Гуленова", "Петрук", "Бойко"};

        System.out.println("Arrays in original order: " + Arrays.toString(arrCustom));

        Arrays.sort(arrCustom);

        System.out.println("Sorted arrays in ascending order: " + Arrays.toString(arrCustom));
    }

    //task2
    //int startInterval = 0;
    //int endInterval = 0;
    //Customer.Interval(int NumCreditCard, c)
    ...
    Product prod[0] = new Product(1, "cake", 12345678, "Roshen", 300, 3, 1);
    Product prod[1] = new Product(2, "candy", 33455656, "Svitoch", 200, 60, 5);
    Product prod[2] = new Product(3, "biscuit", 12435678, "Svitoch", 150, 4, 1);
    Product prod[3] = new Product(4, "lollipops", 12789678, "Konti", 120, 70, 1);
    Product prod[4] = new Product(5, "marshmallow", 14345678, "Solodka Mriya", 240, 5, 6);
    Product prod[5] = new Product(6, "chocolate", 12333678, "Roshen", 300, 140, 1);
}
